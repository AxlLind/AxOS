...
#[inline(always)]
pub fn io_send(port: u16, v: u8) {
  unsafe { asm!("out dx,al", in("dx") port, in("al") v); }
}

#[inline(always)]
pub fn io_read(port: u16) -> u8 {
  let i;
...
#[inline(always)]
pub fn io_send_u16(port: u16, v: u16) {
  unsafe { asm!("out dx,ax", in("dx") port, in("ax") v); }
}

#[inline(always)]
pub fn io_read_u16(port: u16) -> u16 {
  let i;
...
#[inline(always)]
pub fn io_send_u32(port: u16, v: u32) {
  unsafe { asm!("out dx,eax", in("dx") port, in("eax") v); }
}

#[inline(always)]
pub fn io_read_u32(port: u16) -> u32 {
  let i;
