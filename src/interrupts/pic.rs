...
// interrupts
const TIMER_INTERRUPT: u8 = 1 << 0;
const KEYBOARD_INTERRUPT: u8 = 1 << 1;

const PIC1_INTERRUPTS: u8 = !(TIMER_INTERRUPT | KEYBOARD_INTERRUPT);
...
pub fn initialize() {
  ...
  io::send(PIC1_DATA, PIC1_INTERRUPTS); // enable/disable certain interrupts
